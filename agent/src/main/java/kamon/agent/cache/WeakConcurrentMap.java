 ...
 *
 * taken from: https://github.com/raphw/weak-lock-free/blob/master/src/main/java/com/blogspot/mydailyjava/weaklockfree/WeakConcurrentMap.java
 * @credits to @raphw
 */
public class WeakConcurrentMap<K, V> extends ReferenceQueue<K> implements Runnable, Iterable<Map.Entry<K, V>> {
    ...
    public static <K, V> WeakConcurrentMap<K, V> instance() {
        return new WeakConcurrentMap.WithInlinedExpunction<>();
    }
