...
public class ClassWriterFlags {
    ...
    /**
     * In versions of the JVM  &gt; 1.5 bytecode, classes contain a stack map along with the method code.
     *
     * This map describes the layout of the stack at key points (jump targets) during the method's execution.
     *
